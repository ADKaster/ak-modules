...
export module AK:BigIntBase;
import :BuiltinWrappers;
import :Span;
import :Concepts;
import :Types;
...
export constexpr size_t word_size = bit_width<NativeWord>;
export constexpr NativeWord max_word = ~static_cast<NativeWord>(0);
...
export struct StorageOperations {
...
export using Detail::StorageOperations;
export using Detail::NativeWord;
export using Detail::word_size;
export using Detail::max_word;
export using Detail::UnsignedStorageSpan;
export using Detail::UnsignedStorageReadonlySpan;
