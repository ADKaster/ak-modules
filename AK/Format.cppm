...
export module AK:Format;
import :AllOf;
import :AnyOf;
import :CheckedFormatString;
import :Concepts;
import :Error;
import :Forward;
import :NumericLimits;
import :Optional;
import :StringView;
import :Types;
...
export class TypeErasedFormatParams;
class FormatParser;
class FormatBuilder;
...
export enum AllowDebugOnlyFormatters {
    No,
    Yes
};
...
export template<AllowDebugOnlyFormatters allow_debug_formatters, typename... Parameters>
...
export struct StandardFormatter {
    enum class Mode {
        Default,
        Binary,
        BinaryUppercase,
...
export template<typename T, size_t inline_capacity>
requires(HasFormatter<T>)
...
export ErrorOr<void> vformat(StringBuilder&, StringView fmtstr, TypeErasedFormatParams&);

#if !defined(KERNEL)
export void vout(FILE*, StringView fmtstr, TypeErasedFormatParams&, bool newline = false);

export template<typename... Parameters>
...
export inline void outln(FILE* file) { fputc('\n', file); }
...
export inline void outln() { outln(stdout); }
...
export inline void warnln() { outln(stderr); }
...
export void vout(LogLevel, StringView fmtstr, TypeErasedFormatParams&, bool newline = false);
...
export inline void outln() { outln(""); }
...
export inline void warnln() { warnln(""); }

export void set_log_tag_name(char const*);
#    endif // AK_OS_ANDROID

export void vdbg(StringView fmtstr, TypeErasedFormatParams&, bool newline = false);
...
export inline void dbgln() { dbgln(""); }

export void set_debug_enabled(bool);
export void set_rich_debug_enabled(bool);

#ifdef KERNEL
export void vdmesgln(StringView fmtstr, TypeErasedFormatParams&);
...
export void v_critical_dmesgln(StringView fmtstr, TypeErasedFormatParams&);
...
export template<typename T, typename ErrorType>
...
#    ifdef KERNEL
export using AK::critical_dmesgln;
export using AK::dmesgln;
#    else
export using AK::out;
export using AK::outln;

export using AK::warn;
export using AK::warnln;
#    endif

export using AK::dbg;
export using AK::dbgln;

export using AK::CheckedFormatString;
export using AK::FormatIfSupported;
export using AK::FormatString;
#endif
