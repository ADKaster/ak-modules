...
export module AK:StdLibExtras;
export import :StdLibExtraDetails;
...
namespace AK {
export using AK_REPLACED_STD_NAMESPACE::forward;
export using AK_REPLACED_STD_NAMESPACE::move;
}
...
export template<typename T, typename SizeType = decltype(sizeof(T)), SizeType N>
...
#define __DEFINE_GENERIC_ABS(type, zero, intrinsic) \
    export constexpr type abs(type num)             \
    {                                               \
        if (is_constant_evaluated())                \
...
export using AK::array_size;
export using AK::ceil_div;
export using AK::clamp;
export using AK::exchange;
export using AK::forward;
export using AK::is_constant_evaluated;
export using AK::is_power_of_two;
export using AK::max;
export using AK::min;
export using AK::mix;
export using AK::move;
export using AK::RawPtr;
export using AK::round_up_to_power_of_two;
export using AK::swap;
export using AK::to_underlying;
#endif
