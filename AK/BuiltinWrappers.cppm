...
export module AK:BuiltinWrappers;
import :Concepts;

namespace AK {

export template<Unsigned IntType>
...
export inline constexpr int count_leading_zeroes(unsigned __int128 value)
{
#    if defined(AK_COMPILER_CLANG) || defined(AK_COMPILER_GCC)
...
export template<Integral IntType>
...
export using AK::bit_scan_forward;
export using AK::count_leading_zeroes;
export using AK::count_leading_zeroes_safe;
export using AK::count_required_bits;
export using AK::count_trailing_zeroes;
export using AK::count_trailing_zeroes_safe;
export using AK::popcount;
#endif
