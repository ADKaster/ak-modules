...
export module AK:FloatingPoint;
...
export template<size_t S, size_t E, size_t M>
...
export typedef FloatingPointBits<1, 8, 23> SingleFloatingPointBits;
export typedef FloatingPointBits<1, 11, 52> DoubleFloatingPointBits;
...
export using AK::DoubleFloatingPointBits;
export using AK::FloatExtractor;
export using AK::FloatingPointBits;
export using AK::SingleFloatingPointBits;

export using AK::convert_from_native_double;
export using AK::convert_from_native_float;
export using AK::convert_to_native_double;
export using AK::convert_to_native_float;
export using AK::float_to_float;
#endif
