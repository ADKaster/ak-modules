...
export constexpr u32 string_hash(char const* characters, size_t length, u32 seed = 0)
{
    u32 hash = seed;
...
export constexpr u32 case_insensitive_string_hash(char const* characters, size_t length, u32 seed = 0)
{
